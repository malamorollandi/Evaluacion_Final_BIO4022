...
De acuerdo a los valores de AIC de cada modelo descritos en la Tabla 2, el modelo que mejor explica los resultados corresponde al modelo con un AIC de  `r (Modelos %>% select(AIC, Modelo) %>% filter(Modelo == "Fit2"))`.
